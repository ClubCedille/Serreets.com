...
function gardenia_framework_menu_settings() {
	$gardenia_menu = array(
				'page_title' => __( 'Theme Options', 'gardenia'),
				'menu_title' => __('Theme Options', 'gardenia'),
  ...
  <div class="gardenia-header">
    <div class="logo">
      <?php
		...
		echo "<a href='https://fasterthemes.com/' target='_blank'><img src='".esc_url($gardenia_image)."' alt='FasterThemes' /></a>";
		?>
    </div>
          ...
          <!-- Social group -->          
		   ...
		   <div id="options-group-4" class="group theme-option-inner-tabs gardenia-pro-image">  
			<div class="gardenia-pro-header">
              ...
              <a href="https://fasterthemes.com/wordpress-themes/gardenia/" target="_blank">
